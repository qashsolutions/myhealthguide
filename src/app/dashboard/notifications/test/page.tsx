...
// DISABLED PAGE: This test page is for Twilio SMS which is now disabled
// Using Firebase Phone Auth instead
export default function TestSMSPage() {
  ...
  const handleSendTest = async (type: 'reminder' | 'missed' | 'summary' | 'alert') => {
    // DISABLED: Twilio SMS functionality
    alert('SMS testing disabled - using Firebase Phone Auth instead');
    return;
