    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Welcome back! Sign in to manage your care agency.
        </p>
      </div>
      ...
      <Card className="border-purple-200 dark:border-purple-800">
        <CardHeader>
          ...
          <CardDescription>
            Enter your credentials to access your agency account
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/agency/signup" className="text-purple-600 hover:underline">
              Sign up
            </Link>
          </p>
        </CardFooter>
