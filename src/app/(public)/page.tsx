...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Section 2: Tools for Better Care (Features) */}
      ...
      {/* Section 4: For Families & Agencies Cards */}
      <section className="py-16 sm:py-20 bg-white dark:bg-gray-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              Whether you&apos;re caring for a loved one at home or managing multiple clients, we have you covered.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Link href="/family" className="group">
              <Card className="h-full hover:shadow-xl transition-all hover:border-blue-300 dark:hover:border-blue-600">
                <CardContent className="pt-8 pb-6 px-6 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Care for your loved ones with voice-powered medication tracking, health summaries, and family collaboration.
                  </p>
            ...
            <Link href="/agency" className="group">
              <Card className="h-full hover:shadow-xl transition-all hover:border-purple-300 dark:hover:border-purple-600">
                <CardContent className="pt-8 pb-6 px-6 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Manage multiple clients with agency dashboards, caregiver assignments, and compliance tracking.
                  </p>
                  <span className="inline-flex items-center text-purple-600 dark:text-purple-400 font-semibold group-hover:gap-2 transition-all">
                    Learn More <ArrowRight className="w-4 h-4 ml-1" />
                  </span>
                </CardContent>
              </Card>
