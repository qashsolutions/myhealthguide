      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Each phone number is eligible for <strong>one free trial</strong>. All plans include a <strong>15-day free trial</strong>. We enforce this by storing a hash of your phone number. Attempting to create multiple trial accounts with the same phone number violates these Terms.
            </p>
