      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Each phone number is eligible for <strong>one free trial</strong>. Trial periods vary by plan: <strong>45 days for Family Plan A and Family Plan B</strong>, and <strong>30 days for the Multi Agency Plan</strong>. We enforce this by storing a hash of your phone number. Attempting to create multiple trial accounts with the same phone number violates these Terms.
            </p>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">7.2 User Responsibility for Smart Content Output</h3>
            <p className="mb-4">
              <strong>You are solely responsible for verifying the accuracy, completeness, and appropriateness of any smart content generated based on your inputs before applying it to any medical, health, or professional use.</strong>
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>You agree that you will not rely solely on smart content for any critical decision-making, including clinical decision-making, medication management, or health-related decisions</li>
              <li>You agree to independently verify all smart summaries, recommendations, and analyses with qualified healthcare professionals</li>
              <li>You understand that Qash Solutions Inc. makes no representations or warranties regarding the accuracy of smart content</li>
            </ul>
            <p className="mb-4 text-sm text-gray-600 dark:text-gray-400 italic">
              Note: We use AI tools to generate these smart insights. All smart content is provided solely as an observation to assist you and should not be considered medical advice or a substitute for professional judgment.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">7.3 Smart Features Covered</h3>
            <p className="mb-4">This disclaimer applies to all smart content generated based on your inputs, including but not limited to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>Daily health summaries and insights</li>
              <li>Medication compliance analysis</li>
              <li>Diet and nutrition analysis</li>
              <li>Smart assistant responses</li>
              <li>Voice transcription and interpretation</li>
              <li>Pattern detection and trend analysis</li>
              <li>Any other smart feature that generates content based on your inputs</li>
            </ul>
            <p className="mb-4 text-sm text-gray-600 dark:text-gray-400 italic">
              Note: We use AI tools to generate these smart insights. All smart content is provided solely as an observation to assist you and should not be considered medical advice or a substitute for professional judgment.
            </p>
