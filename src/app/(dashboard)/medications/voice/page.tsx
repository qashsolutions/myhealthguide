...
export default function VoiceMedicationPage() {
  ...
  const handleConfirm = async (parsedData: VoiceParseResult, editedTranscript: string) => {
    try {
      // TODO: Connect to Firebase to log medication
      console.log('Logging medication via voice:', {
        ...parsedData,
        transcript: editedTranscript
      });

      setSuccess(`Successfully logged ${parsedData.itemName} for ${parsedData.elderName || 'elder'}`);
      setShowDialog(false);
      ...
      setError('Failed to log medication. Please try again.');
    }
  };
