...
export default function VoiceDietPage() {
  ...
  const handleConfirm = async (parsedData: VoiceParseResult, editedTranscript: string) => {
    try {
      // TODO: Connect to Firebase to log diet entry
      console.log('Logging diet entry via voice:', {
        ...parsedData,
      ...
      setSuccess(`Successfully logged ${mealType} for ${parsedData.elderName || 'elder'}`);
      setShowDialog(false);
      setAnalysis(null);
