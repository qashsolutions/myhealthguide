...
export async function sendTestNotification(
  ...
  try {
    await sendSMS(phoneNumber, 'Test notification from MyHealthGuide. Your SMS notifications are working!');
    await sendEmail(email, 'Test Notification', 'Test notification from MyHealthGuide. Your email notifications are working!');
