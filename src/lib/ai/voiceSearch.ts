...
const SEARCH_KNOWLEDGE_BASE = {
  pricing: {
    ...
    trial: {
      ...
      description: 'All plans include a 15-day free trial. You can cancel anytime during the trial for a full refund. No credit card required upfront.',
      url: '/pricing',
    },
    refund: {
      title: 'Refund Policy',
...
${isPublicUser ? '- If public user asks about personal data features, encourage them to sign up for 15-day free trial' : ''}
...
function buildKnowledgeContext(permissions?: {
  ...
  if (!permissions) {
    ...
    context += '\n## HOW TO GET STARTED:\n';
    context += '- Sign Up: Go to /signup for 15-day free trial\n';
    ...
    context += '- Must sign up for 15-day free trial to use the app\n';
